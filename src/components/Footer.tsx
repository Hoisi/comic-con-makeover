...
const Footer = () => {
  return <footer className="bg-forest text-white py-12 relative overflow-hidden">
      {/* Decorative palm tree */}
      <img src={palmTree} alt="" className="absolute bottom-0 right-0 h-64 md:h-80 lg:h-96 w-auto opacity-20 pointer-events-none" aria-hidden="true" />
      <div className="container relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div>
            <img src={hydeLogo} alt="Hyde Hermit Studio" className="h-57 w-auto mb-4" />
          ...
          <div>
            ...
            <div className="flex gap-4">
              ...
              <a href="#" className="text-white/80 hover:text-white transition-colors" aria-label="X">
